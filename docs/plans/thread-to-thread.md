...
4. Add bounded, idempotent progress records and explicit result submission. A
   result may include test evidence, operation IDs and commit/tree identities,
   but is not permission to publish or proof of externally verified success.
